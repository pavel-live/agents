...
Общее описание подхода: [00_agent_development.md](./00_agent_development.md)
...
- [02_analyst_prompt.md](./02_analyst_prompt.md)
- [03_tz_reviewer_prompt.md](./03_tz_reviewer_prompt.md)
- [04_architect_prompt.md](./04_architect_prompt.md)
- [05_architecture_reviewer_prompt.md](./05_architecture_reviewer_prompt.md)
- [06_agent_planner.md](./06_agent_planner.md)
- [07_agent_plan_reviewer.md](./07_agent_plan_reviewer.md)
- [08_agent_developer.md](./08_agent_developer.md)
- [09_agent_code_reviewer.md](./09_agent_code_reviewer.md)
...
Модель:
аналитик, архитектор, планировщик — auto 
